...
class Aluno extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
          strapi_url: this.props.strapi_url + '/alunos',
          searchbar_Id: "",
          layout:"initial",
          disabled:true,
          msg_text: null,
    ...
    saveRegister = () => {
        ...
        let token = 'Bearer ' + this.props.jwt;
    ...
    handleSubmit_searchbar = (e) => {
        ...
        if (!isNaN(this.state.searchbar_Id))
            this.findRegister(this.state.searchbar_Id);
    }
        ...
        switch(identifier) {
            ...
            case "create_new":
                ...
                return (
                    <div className="row mb-2">
                        <div className="col-12 text-center">
                            <input className="mx-2" type="submit" value="Save" onClick={() => this.saveRegister()} />
                ...
                return (
                    <div className="row mb-2">
                        <div className="col-12 text-center">
                            ...
                            <input className="mx-2 btn-danger" type="submit" value="Delete" onClick={() => this.deleteRegister(this.state.id)} />
                        </div>
                    </div>
                );
